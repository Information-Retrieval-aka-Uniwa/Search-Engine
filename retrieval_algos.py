    ...
    for i, term in enumerate(terms):
        ...
        if term == "and" and i > 0 and i < len(terms) - 1:             # Έλεγχος για το αν ο όρος κλειδί (term) είναι ο "and" και αν βρίσκεται μεταξύ δύο όρων κλειδιών (terms)
            ...
            if previous_term in inverted_index and next_term in inverted_index:
                ...
                common_documents = set(documents_with_previous_term) & set(documents_with_next_term)
                matching_papers.extend(common_documents)
            ...
            if next_term not in inverted_index:
                ...
                for document in documents_without_next_term:           
                    matching_papers.append(document) 
